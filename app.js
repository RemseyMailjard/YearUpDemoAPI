...
app.get("/", (req, res) => {
  ...
  const apiEndpoints = {
    "All Users": "yearupdemoapi.azurewebsites.net/api/users",
    "User by ID": "yearupdemoapi.azurewebsites.net/api/users/:id",
    "Users by Group Name":
      "yearupdemoapi.azurewebsites.net/api/users/group/:groupname",
    "Users by Coding Nickname":
      "yearupdemoapi.azurewebsites.net/api/users/nickname/:nickname",
    "Update User":
      "yearupdemoapi.azurewebsites.net/api/users/:id (PUT request)",
    "Delete User":
      "yearupdemoapi.azurewebsites.net/api/users/:id (DELETE request)",
  };
